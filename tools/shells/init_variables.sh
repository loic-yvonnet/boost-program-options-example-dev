...
# Others
export target_program_name=yoctoboost
export target_program_path=${build_directory}/${target_program_name}
export docker_target_program_path=${docker_build_directory}/${target_program_name}
export docker_test_suite=${docker_build_directory}/tests
